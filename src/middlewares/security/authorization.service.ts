  ...
  verifyIsAllowedTo(permission: Permission) {
    return function (
      ...
      try {
        ...
        const username = (res.locals.username as any as string);
  ...
  verifyOldPasswordValid() {
    return function (
      ...
      const {
        ...
        newPassword,
        newPasswordCheck,
      } = (req.body as any as UserPasswordChange);
  ...
  verifyGivenPermissionsNotExceedOwned() {
    return function (
      ...
      try {
        ...
        const userToCreatePermissions: Permissions = (req.body as any as User)
          .permissions;
