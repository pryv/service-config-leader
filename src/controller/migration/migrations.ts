...
const migrations: Array<Migration> = addTemplateUpgradeToEmptyRuns([
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.7.10-template.yml'),
    },
    cluster: {
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.7.11-template.yml'),
    },
    cluster: {
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.7.12-template.yml'),
    },
    cluster: {
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.7.13-template.yml'),
    },
    cluster: {
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.7.14-template.yml'),
    },
    cluster: {
  ...
  },
  {
    ...
    singlenode: {
      ...
      template: loadTemplate('scriptsAndTemplates/single-node/1.8.0-template.yml'),
    },
    cluster: {
