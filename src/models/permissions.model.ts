...
type UsersPermission = "read" | "resetPassword" | "changePermissions" | "create" | "delete";
export type PermissionsGroup = "users" | "settings" | "platformUsers";
export type Permission = SettingsPermission | UsersPermission | PlatformUsersPermission;
