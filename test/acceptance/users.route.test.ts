...
describe('Test /users endpoint', () => {
  ...
  describe('POST /users', () => {
    ...
    it('must respond with 401 when given token with insufficient permissions', async () => {
      ...
      app.usersRepository.createUser(((userNoCreatePerm as any as User)));
    ...
    it('must respond with 401 when given user with more permissions than creator', async () => {
      ...
      app.usersRepository.createUser(((userLimitedPerms as any as User)));
  ...
  describe('GET /users', () => {
    ...
    it('must respond with 401 when given token with insufficient permissions', async () => {
      ...
      app.usersRepository.createUser(((userNoReadPerm as any as User)));
  ...
  describe('PUT /users/:username/permissions', () => {
    ...
    beforeEach(() => {
      app.usersRepository.createUser(((userToUpdate as any as User)));
    });
    ...
    it('must respond with 401 when given token with insufficient permissions', async () => {
      ...
      app.usersRepository.createUser(((userNoChangePermsPerm as any as User)));
  ...
  describe('POST /users/:username/reset-password', () => {
    ...
    beforeEach(() => {
      app.usersRepository.createUser(((userToResetPassFor as any as User)));
    });
    ...
    it('must respond with 401 when given token with insufficient permissions', async () => {
      ...
      app.usersRepository.createUser(((userNoResetPassPerm as any as User)));
  ...
  describe('DELETE /users/:username', () => {
    ...
    beforeEach(() => {
      app.usersRepository.createUser(((userToDelete as any as User)));
    });
    ...
    it('must respond with 401 when given token with insufficient permissions', async () => {
      ...
      app.usersRepository.createUser(((userNoDelPerm as any as User)));
